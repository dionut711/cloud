...
from global_refs.views import review as entity_view
from global_refs.views import reviews as collection_view

import services
import model.review
from global_refs.services import users as users_service
from global_refs.services import topics as topics_service
from global_refs.model import database as database
from global_refs.mappers import review as mapper

factory = model.review.ReviewsFactory(users_service, topics_service)
service = services.EntityService(database, mapper, factory)
